...
function lef_enqueue_assets() {
	...
	wp_enqueue_style(
		'lef-global-styles',
		LEF_PLUGIN_URL . 'components/global/global.css',
		array(),
		filemtime( LEF_PLUGIN_DIR . 'components/global/global.css' )
	);
	...
	if ( is_a( $post, 'WP_Post' ) ) {
		...
		if ( has_shortcode( $post->post_content, 'lef_my_profile' ) ) {
			...
			wp_enqueue_script(
				'lef-phone-core-js',
				LEF_PLUGIN_URL . 'components/global/phone-core.js',
				array(),
				filemtime( LEF_PLUGIN_DIR . 'components/global/phone-core.js' ),
				true
			);
...
function lef_enqueue_global_components() {
	...
	wp_enqueue_style(
		'lef-toaster',
		LEF_PLUGIN_URL . 'components/toaster/toaster.css',
		array(),
		filemtime( LEF_PLUGIN_DIR . 'components/toaster/toaster.css' )
	);
	wp_enqueue_script(
		'lef-toaster-js',
		LEF_PLUGIN_URL . 'components/toaster/toaster.js',
		array(),
		filemtime( LEF_PLUGIN_DIR . 'components/toaster/toaster.js' ),
		true
	);

	wp_add_inline_script(
		'lef-toaster-js',
		'window.lefGetImageUrl = function(name) {
			var baseUrl = "' . esc_js( LEF_PLUGIN_URL ) . 'images/";
	...
	wp_enqueue_style(
		'lef-confirmation',
		LEF_PLUGIN_URL . 'components/confirmation/confirmation.css',
		array(),
		filemtime( LEF_PLUGIN_DIR . 'components/confirmation/confirmation.css' )
	);
	wp_enqueue_script(
		'lef-confirmation-js',
		LEF_PLUGIN_URL . 'components/confirmation/confirmation.js',
		array(),
		filemtime( LEF_PLUGIN_DIR . 'components/confirmation/confirmation.js' ),
		true
	);
}
 ...
 *
 * @param string $relative_path Path relative to the plugin root (e.g., 'images/placeholder.png').
...
function lef_render_global_components() {
	include LEF_PLUGIN_DIR . 'components/toaster/toaster.php';
	include LEF_PLUGIN_DIR . 'components/confirmation/confirmation.php';
}
