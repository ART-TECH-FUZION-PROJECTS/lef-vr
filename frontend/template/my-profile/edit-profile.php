...
<div class="lef-edit-prof-wrapper" id="lef-edit-prof-panel">
    ...
    <div class="lef-edit-prof-photo-row lef-edit-prof-p-m-b-common">
        <div class="lef-edit-prof-photo-preview" id="lef-edit-prof-avatar-preview">
            <img src="<?php echo $profile_pic ? esc_url($profile_pic) : esc_url(lef_get_image_url('placeholder-avatar.png')); ?>" alt="Profile preview" onerror="this.onerror=null; this.src='<?php echo esc_url(lef_get_image_url('placeholder-avatar.png')); ?>';">
        </div>
