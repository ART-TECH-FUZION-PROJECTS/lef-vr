...
$placeholder_pic     = lef_get_image_url('placeholder-avatar.png');
$placeholder_prop    = lef_get_image_url('placeholder.png');
$placeholder_amenity = lef_get_image_url('amenity-placeholder.svg');
...
$heart_svg_filled = '<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; fill: var(--lef-primary-color); height: 16px; width: 16px; stroke: var(--lef-primary-color); stroke-width: 2; overflow: visible;"><path d="m15.9998 28.6668c7.1667-4.8847 14.3334-10.8844 14.3334-18.1088 0-1.84951-.6993-3.69794-2.0988-5.10877-1.3996-1.4098-3.2332-2.11573-5.0679-2.11573-1.8336 0-3.6683.70593-5.0668 2.11573l-2.0999 2.11677-2.0988-2.11677c-1.3995-1.4098-3.2332-2.11573-5.06783-2.11573-1.83364 0-3.66831.70593-5.06683 2.11573-1.39955 1.41083-2.09984 3.25926-2.09984 5.10877 0 7.2244 7.16667 13.2241 14.3333 18.1088z"></path></svg>';
...
<div class="lef-global-plugin-wrapper" id="lef-spv-root" data-property-id="<?php echo esc_attr($property_id); ?>"
    data-price="<?php echo esc_attr($price); ?>" data-max-guests="<?php echo esc_attr($guests); ?>"
	...
	<?php
	// Fullscreen Loading Overlay for layout transitions.
	$lef_loader_logo     = '🏡';
	$lef_loader_title    = __( 'Loading property details', 'listing-engine-frontend' );
	$lef_loader_subtitle = __( 'Preparing the optimal view for your device', 'listing-engine-frontend' );
	include LEF_PLUGIN_DIR . 'components/loading-screen/loading-screen.php';
	?>
    ...
    <div class="lef-dk-main-cont" id="lef-spv-desktop">
        ...
        <div class="lefdk-title-cont">
            ...
            <div class="lefdk-extra-cont">
                ...
                <div class="lefdk-h-btn" id="lef-spv-wishlist-btn">
                    <span
                        class="lef-spv-heart-icon"><?php echo $is_wishlisted ? $heart_svg_filled : $heart_svg_empty; ?></span>Save
                </div>
            </div>
        </div>
        ...
        <div class="lefdk-img-cont">
            ...
            <div class="lefdk-img-1">
                <img src="<?php echo esc_url($images[0]); ?>" alt="<?php echo $title; ?>"
                    onerror="this.src='<?php echo esc_url($placeholder_prop); ?>';">
            </div>
            <?php endif; ?>
            ...
            <div class="lefdk-d-right">
                ...
                <div class="lefdk-d-title-cont">
                    ...
                    <div class="lefdk-review">
                        ...
                        <div class="lefdk-r-total-revi"><span class="lefdk-dot"> · </span><?php echo $review_count; ?>
                            reviews</div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="lefdk-host-details">
                    <div class="lefdk-hd-photo">
                        <img src="<?php echo esc_url($host_pic); ?>" alt="<?php echo esc_attr($host_name); ?>"
                            onerror="this.src='<?php echo esc_url($placeholder_pic); ?>';">
                    </div>
                ...
                <div class="lefdk-amenity-cont">
                    ...
                    <ol class="lefdk-am-lists">
                        ...
                        <list class="lefdk-am-li-list">
                            <span class="lefdk-am-li-svg">
                                <?php if ($am['svg_path']) : ?>
                                <img src="<?php echo esc_url($am['svg_path']); ?>" alt=""
                                    style="display:block; height:24px; width:24px;"
                                    onerror="this.src='<?php echo esc_url($placeholder_amenity); ?>';">
                                <?php endif; ?>
                            </span>
                    ...
                    <div class="lefdk-show-amenity-btn" id="lef-spv-amenity-more">Show all
                        <?php echo count($amenities_list); ?> amenities</div>
                    <?php endif; ?>
                </div>
                ...
                <div class="lefdk-l-form-cont" id="lef-spv-reserve-form">
                    ...
                    <div class="lef-spv-guests-dropdown" id="lef-spv-guests-dropdown" style="display:none;">
                        <div class="lef-spv-gd-row">
                            <div class="lef-spv-gd-info"><span class="lef-spv-gd-title">Adults</span><span
                                    class="lef-spv-gd-sub">Age 13+</span></div>
                        ...
                        <div class="lef-spv-gd-row">
                            <div class="lef-spv-gd-info"><span class="lef-spv-gd-title">Children</span><span
                                    class="lef-spv-gd-sub">Age 2–12</span></div>
                            <div class="lef-spv-gd-controls">
                        ...
                        <div class="lef-spv-gd-row">
                            <div class="lef-spv-gd-info"><span class="lef-spv-gd-title">Infants</span><span
                                    class="lef-spv-gd-sub">Under 2</span></div>
                            <div class="lef-spv-gd-controls">
                    ...
                    <?php if ($is_host) : ?>
                    <button class="lefdk-lf-btn" style="opacity: 0.6; cursor: not-allowed;" disabled>Hosts cannot
                        reserve</button>
                    <?php else : ?>
        ...
        <div class="lefdk-all-review">
            <div class="lefdk-ar-review">
                ...
                <div class="lefdk-ar-r-total-revi"><span class="lefdk-dot"> · </span><?php echo $review_count; ?>
                    reviews</div>
                <?php else : ?>
            ...
            <div class="lefdk-review-cards">
                ...
                <div class="lefdk-rc-card">
                    ...
                    <div class="lefdk-rc-r-info-cont">
                        <div class="lefdk-rc-date"><span
                                class="lefdk-rc-rating"><?php echo lef_render_review_stars($rev['rating']); ?></span>
                            <?php echo " - " . lef_format_review_date($rev['created_at']); ?> </div>
                        <p class="lefdk-rc-text">
                            <?php
                                            ...
                                            ?>
                            <span class="lef-spv-see-more" data-avatar="<?php echo esc_url($rev['avatar']); ?>"
            ...
            <div class="lefdk-show-amenity-btn" id="lef-spv-reviews-more">Show all <?php echo $review_count; ?> reviews
            </div>
            <?php endif; ?>
    ...
    <div class="lef-mb-main-cont" id="lef-spv-mobile">
        ...
        <div class="lefmb-header-cont">
            ...
            <div class="lefmb-extra-btn-cont">
                ...
                <span class="lefmb-e-btn" id="lef-spv-wishlist-btn-mb">
                    <span
                        class="lef-spv-heart-icon"><?php echo $is_wishlisted ? $heart_svg_filled : $heart_svg_empty; ?></span>
                </span>
            </div>
        </div>
        ...
        <div class="lefmb-prop-details-cont">
            ...
            <div class="lefmb-prop-heading-cont">
                ...
                <div class="lefmb-prop-title-cont">
                    ...
                    <div class="lefmb-review">
                        ...
                        <div class="lefmb-r-total-revi"><span class="lefmb-dot"> · </span><?php echo $review_count; ?>
                            reviews</div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="lefmb-amenity-cont">
                ...
                <?php if ($amenities_extra) : ?>
                <div class="lefmb-show-amenity-btn" id="lef-spv-amenity-more-mb">Show all
                    <?php echo count($amenities_list); ?> amenities</div>
                <?php endif; ?>
            </div>
            ...
            <div class="lefmb-all-review">
                <div class="lefmb-ar-review">
                    ...
                    <div class="lefmb-ar-r-total-revi"><span class="lefmb-dot"> · </span><?php echo $review_count; ?>
                        reviews</div>
                    <?php else : ?>
                ...
                <div class="lefmb-review-cards">
                    ...
                    <div class="lefmb-rc-card">
                        ...
                        <div class="lefmb-rc-r-info-cont">
                            <div class="lefmb-rc-date"><span
                                    class="lefmb-rc-rating"><?php echo lef_render_review_stars($rev['rating']) . "-"; ?></span><?php echo lef_format_review_date($rev['created_at']); ?>
                            </div>
                ...
                <?php if ($reviews_extra) : ?>
                <div class="lefmb-show-amenity-btn" id="lef-spv-reviews-more-mb">Show all <?php echo $review_count; ?>
                    reviews</div>
                <?php endif; ?>
            ...
            <div class="lefmb-similar-results" style="display: none;">
                <div class="lefdk-sm-header-cont">
                    ...
                    <div class="lefdk-sm-nav">
                        <button class="lefdk-sm-nav-btn"
                            id="lef-spv-sm-prev-mb"><?php echo $slider_prev_svg; ?></button>
                        <button class="lefdk-sm-nav-btn"
                            id="lef-spv-sm-next-mb"><?php echo $slider_next_svg; ?></button>
                    </div>
                </div>
    ...
    <div class="lef-spv-modal" id="lef-spv-reviews-modal" style="display:none;">
        <div class="lef-spv-modal-header">
            ...
            <h2><?php echo $review_count > 0 ? $star_svg_sm . ' ' . $avg_rating . ' · ' . $review_count . ' reviews' : 'Reviews'; ?>
            </h2>
        </div>
        <div class="lef-spv-modal-body lef-spv-reviews-full">
            ...
            <div class="lefdk-rc-card">
                ...
                <div class="lefdk-rc-date"><?php echo lef_format_review_date($rev['created_at']); ?><span
                        class="lefdk-rc-rating"><?php echo lef_render_review_stars($rev['rating']); ?></span></div>
                <p class="lefdk-rc-text">
                    <?php
                        $full_review = $rev['review'];
                        if (mb_strlen($full_review) > $lef_review_char_limit) :
    ...
    <div class="lef-spv-modal" id="lef-spv-review-form-modal" style="display:none;">
        <div class="lef-spv-modal-inner">
            ...
            <div class="lef-spv-modal-body">
                ...
                <textarea id="lef-spv-review-text" placeholder="Write your review here..."
                    rows="5"><?php echo $has_review ? esc_textarea($existing_review->review) : ''; ?></textarea>
            ...
            <div class="lef-spv-modal-body">
                <div class="lefdk-rc-card" style="border:none; padding:0; width:100%;">
                    ...
                    <div class="lefdk-rc-r-info-cont">
                        ...
                        <p class="lefdk-rc-text" id="lef-review-detail-text" style="font-size:1.6rem; line-height:1.6;">
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="lef-spv-guests-dropdown" id="lef-spv-mb-guests-dropdown" style="display:none;">
                        <div class="lef-spv-gd-row">
                            <div class="lef-spv-gd-info"><span class="lef-spv-gd-title">Adults</span><span
                                    class="lef-spv-gd-sub">Age 13+</span></div>
                            <div class="lef-spv-gd-controls">
                                <button class="lef-spv-gd-btn" data-action="minus" data-type="adults"
                                    data-ctx="mb">−</button>
                                <span class="lef-spv-gd-count" id="lef-spv-mb-adults-count">1</span>
                                <button class="lef-spv-gd-btn" data-action="plus" data-type="adults"
                                    data-ctx="mb">+</button>
                            </div>
                        </div>
                        <div class="lef-spv-gd-row">
                            <div class="lef-spv-gd-info"><span class="lef-spv-gd-title">Children</span><span
                                    class="lef-spv-gd-sub">Age 2–12</span></div>
                            <div class="lef-spv-gd-controls">
                                <button class="lef-spv-gd-btn" data-action="minus" data-type="children"
                                    data-ctx="mb">−</button>
                                <span class="lef-spv-gd-count" id="lef-spv-mb-children-count">0</span>
                                <button class="lef-spv-gd-btn" data-action="plus" data-type="children"
                                    data-ctx="mb">+</button>
                            </div>
                        </div>
                        <div class="lef-spv-gd-row">
                            <div class="lef-spv-gd-info"><span class="lef-spv-gd-title">Infants</span><span
                                    class="lef-spv-gd-sub">Under 2</span></div>
                            <div class="lef-spv-gd-controls">
                                <button class="lef-spv-gd-btn" data-action="minus" data-type="infants"
                                    data-ctx="mb">−</button>
                                <span class="lef-spv-gd-count" id="lef-spv-mb-infants-count">0</span>
                                <button class="lef-spv-gd-btn" data-action="plus" data-type="infants"
                                    data-ctx="mb">+</button>
                            </div>
                        </div>
                    </div>
